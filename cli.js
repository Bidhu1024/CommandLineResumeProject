...
inquirer
  ...
  .then((choices) => {
       if(choices.Selection =='About'){
            ...
            cp.execSync('start chrome https://github.com/Bidhu1024')
            displayNext()
       }

       else if(choices.Selection=='Academics'){
              cp.execSync('start chrome https://drive.google.com/drive/u/0/folders/1QUAwzzaIpuRPSaJmfDToDioy9IkkTGsR')
              displayNext()
       }
  })
